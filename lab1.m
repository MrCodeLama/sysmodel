...
% Discrete Fourier Transform with starting data
...
figure
% find delta_f and make graph to find extremums
...
% find local maxes and frequences
...
% build and solve the system of exuasions to find coeficients
